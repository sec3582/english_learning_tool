// js/api.js
export const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwsNqU8JxDyVlPoF4w3DW3v0pCwgGO0SW3r84hPbeo5brwc2FnQCcN76tKyAzqVc6A3DA/exec";
...
async function callAppsScript(action, payload) {
  ...
  if (!res.ok) {
    throw new Error(`Apps Script 請求失敗：${res.status} ${res.statusText}`);
  }
