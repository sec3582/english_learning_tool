...
右側面板對應 Baldini 書房裡那本攤開的帳冊——記錄所有已辨識、收藏的詞彙標本（= 英文詞彙）。

**這個面板不是「右側資料管理欄」——它是整個工具的核心清單：使用者在此查閱積累的詞彙、選擇複習內容、發動測驗。視覺重量與層次深度應是全頁面最高的容器。**
...
**場景論述**：工作桌上攤開的工作紙張。視覺上比底材（桌面/牆面）「輕」——紙張可移動，桌面是固定的。
